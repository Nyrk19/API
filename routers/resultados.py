...
def procesar_video(correo: str, directorio: str, resultados, idUsuario):
    try:
        ...
        temp_output_path = os.path.join(directorio, f"{idUsuario}_temp.mp4")
        final_video.write_videofile(temp_output_path, codec="libx264", threads=4, preset='ultrafast')
        
        final_output_path = os.path.join(directorio, f"{idUsuario}.mp4")
